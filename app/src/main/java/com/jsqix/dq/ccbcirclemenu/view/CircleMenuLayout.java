package com.jsqix.dq.ccbcirclemenu.view;
...
import com.jsqix.dq.ccbcirclemenu.R;
...
public class CircleMenuLayout extends ViewGroup {
    ...
    public void startInit(int s) {

        post(mFlingRunnable = new AutoFlingRunnable(s));
    }
    ...
    public void startInit() {
        post(mFlingRunnable = new AutoFlingRunnable(-356));
    }
}